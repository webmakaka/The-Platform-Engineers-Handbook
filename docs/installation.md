...
4. In Organization Settings → Self-hosted runners, agree to the terms and conditions for using a local runner. _We will set up the runner itself later using Kind._
...
Command-line interface for Bitwarden password manager.

Create a free account at [bitwarden.com](https://bitwarden.com) and generate an API key before use.
...
Command-line tool for validating CircleCI configurations and managing pipelines.
